...
const User = require('../../../../week-11/5-friday/Project-Wayfarer/wayfarer-backend/models').User;
const constants = require('../../../../week-11/5-friday/Project-Wayfarer/wayfarer-backend/constants');
